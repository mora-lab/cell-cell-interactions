...
immu$cell.type[immu$integrated_snn_res.0.5 %in% 14] <- "B cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% c(15,16)] <- "Plasma cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% c(4,6,9)] <- "T cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% 5] <- "NK cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% c(1,13)] <- "Neutrophil"
immu$cell.type[immu$integrated_snn_res.0.5 %in% 8] <- "Mast cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% c(0,2,11)] <- "Macrophage"
immu$cell.type[immu$integrated_snn_res.0.5 %in% 12] <- "Dendritic cell"
immu$cell.type[immu$integrated_snn_res.0.5 %in% c(3,7,10)] <- "Monocyte"
...
allsample <- list.files(pattern =  ".rds$")[-12:-13]
